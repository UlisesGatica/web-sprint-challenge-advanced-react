...
1. What are the main differences between a stateful and a functional component? functional does not use state and stateful use it

2. When does a componentWillMount function be called? What about a componentWillUpdate? componentWillMount after the component is rendered and willUpdated is after willMount

3. Define stateful logic. any code that uses state but in case of hooks

4. What are the three step of creating a successful test? What is done in each phase?
    Arrange:render our app
    Act: Find our elements
    Assert: expect whats on the page
